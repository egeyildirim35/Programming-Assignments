...
private:
	...
	double _load_factor;
	UserNode* _dummy;
	void markVisited(const string& username, vector<bool> &visited,vector<string> &users);
	bool isVisited(const string& username, vector<bool> &visited,vector<string> &users);
	void setDistance(const string& username, int dist,vector<int> &distances,vector<string> &users);
	int getDistance(const string& username,vector<int> &distances,vector<string> &users);
	void setParent(const string& username, const string& parent_name, vector<string>& parent, vector<string>& users) ;
